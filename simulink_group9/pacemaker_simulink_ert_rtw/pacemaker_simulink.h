...
typedef struct {
  ...
  freedomk64f_SCIRead_pacemaker_T obj_m;/* '<S7>/UART Receive' */
  ...
  freedomk64f_DigitalWrite_pace_T obj_mm;/* '<S3>/Digital Write4' */
  ...
  freedomk64f_SCIWrite_pacemake_T obj_k;/* '<S15>/Serial Transmit' */
