...
struct P_pacemaker_simulink_T_ {
  ...
  real_T ATR_CMP_DETECT_SampleTime;    /* Expression: SampleTime
                                        ...
                                        */
  real_T LOWER_RATE_LIMIT_Value;       /* Expression: 130
...
extern void pacemaker_simulink_step(void);
 ...
 * '<S1>'   : 'pacemaker_simulink/Inputs and Programmable Parameters'
 * '<S2>'   : 'pacemaker_simulink/Outputs'
 * '<S3>'   : 'pacemaker_simulink/Pacemaker'
 */
