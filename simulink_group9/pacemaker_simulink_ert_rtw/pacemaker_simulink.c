...
static void enter_atomic_Charging_and_S_mil(const real_T *Gain4, const real_T
  *Gain);
static void pacemaker_simulink_AAI(const real_T *Gain2, const boolean_T
  ...
  *Gain1)
{
  ...
  pacemaker_simulink_B.VENT_CMP_REF_PWM = *Gain5;
}
  ...
  *Gain)
{
  ...
  pacemaker_simulink_B.ATR_CMP_REF_PWM = *Gain4;
}
  ...
  *ATR_CMP_DETECT, const real_T *Gain4, const real_T *Gain)
{
  ...
  if (pacemaker_simulink_P.MODE_SELECT_Value != 2) {
    ...
    switch (pacemaker_simulink_DW.is_AAI) {
     case pacemak_IN_Charging_and_Sensing:
      ...
      pacemaker_simulink_B.ATR_GND_CTRL = 1.0;
      pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
      if (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(60000.0 /
           pacemaker_simulink_P.LOWER_RATE_LIMIT_Value - *Gain2)) {
        ...
        pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
        pacemaker_simulink_B.VENT_PACE_CTRL = 0.0;
      } else if ((!pacemaker_simulink_P.HYSTERESIS_Value) && (*ATR_CMP_DETECT) &&
                 (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil
                  (*Gain2)) && (pacemaker_simulink_DW.temporalCounter_i1 >=
                  (uint32_T)pacemaker_simulink_P.ATR_REFRAC_PERIOD_Value)) {
        ...
        if (pacemaker_simulink_P.HYSTERESIS_Value && (*ATR_CMP_DETECT) &&
            (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(*Gain2)))
        {
          /* Constant: '<S1>/ATR_REFRAC_PERIOD' */
          if (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)
              pacemaker_simulink_P.ATR_REFRAC_PERIOD_Value) {
     ...
     case pacemaker_simulin_IN_Hysteresis:
      ...
      pacemaker_simulink_B.ATR_GND_CTRL = 1.0;
      pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
      if ((*ATR_CMP_DETECT) && (pacemaker_simulink_DW.temporalCounter_i1 >=
           (uint32_T)ceil(*Gain2)) && (pacemaker_simulink_DW.temporalCounter_i1 >=
           (uint32_T)pacemaker_simulink_P.ATR_REFRAC_PERIOD_Value)) {
        pacemaker_simulink_DW.is_AAI = pacemaker_simulin_IN_Hysteresis;
        pacemaker_simulink_DW.temporalCounter_i1 = 0U;
        enter_atomic_Charging_and_S_mil(Gain4, Gain);
        ...
        tmp = rt_roundd_snf(60000.0 /
                            pacemaker_simulink_P.LOWER_RATE_LIMIT_Value +
                            (real_T)
        ...
        if (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)tmp_0) {
          pacemaker_simulink_DW.is_AAI = pacemaker_simulink_IN_Pacing_g;
          pacemaker_simulink_DW.temporalCounter_i1 = 0U;
          pacemaker_simulink_B.FRONTEND_CTRL = 0.0;
          pacemaker_simulink_B.PACE_CHARGE_CTRL = 0.0;
     ...
     default:
      ...
      pacemaker_simulink_B.Z_VENT_CTRL = 0.0;
      pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
      if (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(*Gain2)) {
        pacemaker_simulink_DW.is_AAI = pacemak_IN_Charging_and_Sensing;
        pacemaker_simulink_DW.temporalCounter_i1 = 0U;
        enter_atomic_Charging_and_S_mil(Gain4, Gain);
      }
...
/* Model step function */
void pacemaker_simulink_step(void)
{
  boolean_T tmp;
  real_T Gain3;
  real_T Gain2;
  ...
  ATR_CMP_DETECT = MW_digitalIO_read
    (pacemaker_simulink_DW.obj.MW_DIGITALIO_HANDLE);
  ...
  tmp = MW_digitalIO_read(pacemaker_simulink_DW.obj_n.MW_DIGITALIO_HANDLE);

  /* Gain: '<S1>/Gain' incorporates:
   *  Constant: '<S1>/ATR_PULSE_AMP_REG'
   */
  Gain = pacemaker_simulink_P.Gain_Gain *
    pacemaker_simulink_P.ATR_PULSE_AMP_REG_Value;

  /* Gain: '<S1>/Gain1' incorporates:
   *  Constant: '<S1>/VENT_PULSE_AMP_REG'
   */
  Gain1 = pacemaker_simulink_P.Gain1_Gain *
    pacemaker_simulink_P.VENT_PULSE_AMP_REG_Value;

  /* Gain: '<S1>/Gain2' incorporates:
   *  Constant: '<S1>/ATR_PULSE_WIDTH'
   */
  Gain2 = pacemaker_simulink_P.Gain2_Gain *
    pacemaker_simulink_P.ATR_PULSE_WIDTH_Value;

  /* Gain: '<S1>/Gain3' incorporates:
   *  Constant: '<S1>/VENT_PULSE_WIDTH'
   */
  Gain3 = pacemaker_simulink_P.Gain3_Gain *
    pacemaker_simulink_P.VENT_PULSE_WIDTH_Value;

  /* Gain: '<S1>/Gain4' incorporates:
   *  Constant: '<S1>/ATR_SENS'
   */
  Gain4 = pacemaker_simulink_P.Gain4_Gain * pacemaker_simulink_P.ATR_SENS_Value;

  /* Gain: '<S1>/Gain5' incorporates:
   *  Constant: '<S1>/VENT_SENS'
   */
  Gain5 = pacemaker_simulink_P.Gain5_Gain * pacemaker_simulink_P.VENT_SENS_Value;
  ...
  if (pacemaker_simulink_DW.is_active_c3_pacemaker_simulink == 0U) {
    ...
    switch (pacemaker_simulink_DW.is_c3_pacemaker_simulink) {
     case pacemaker_simulink_IN_AAI:
      pacemaker_simulink_AAI(&Gain2, &ATR_CMP_DETECT, &Gain4, &Gain);
      break;

     case pacemaker_simulink_IN_AOO:
      if (pacemaker_simulink_P.MODE_SELECT_Value != 0) {
      ...
      } else if (pacemaker_simulink_DW.is_AOO == pacemak_IN_Charging_and_Sensing)
      {
        ...
        if ((pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(60000.0 /
              pacemaker_simulink_P.LOWER_RATE_LIMIT_Value - Gain2)) &&
            (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(60000.0 /
              pacemaker_simulink_P.UPPER_RATE_LIMIT_Value - Gain2))) {
     ...
     case pacemaker_simulink_IN_Start:
      switch (pacemaker_simulink_P.MODE_SELECT_Value) {
       case 0:
        pacemaker_simulink_DW.is_c3_pacemaker_simulink =
     ...
     case pacemaker_simulink_IN_VOO:
      if (pacemaker_simulink_P.MODE_SELECT_Value != 1) {
      ...
      } else if (pacemaker_simulink_DW.is_VOO == pacemak_IN_Charging_and_Sensing)
      {
        ...
        pacemaker_simulink_B.VENT_GND_CTRL = 1.0;
        if ((pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(60000.0 /
              pacemaker_simulink_P.LOWER_RATE_LIMIT_Value - Gain3)) &&
            (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(60000.0 /
              pacemaker_simulink_P.UPPER_RATE_LIMIT_Value - Gain3))) {
        ...
        pacemaker_simulink_B.Z_VENT_CTRL = 0.0;
        pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
        if (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(Gain3)) {
          pacemaker_simulink_DW.is_VOO = pacemak_IN_Charging_and_Sensing;
          pacemaker_simulink_DW.temporalCounter_i1 = 0U;
          enter_atomic_Charging_and_Se_mi(&Gain1);
        }
     ...
     default:
      /* case IN_VVI: */
      if (pacemaker_simulink_P.MODE_SELECT_Value != 3) {
        ...
        switch (pacemaker_simulink_DW.is_VVI) {
         case pacemak_IN_Charging_and_Sensing:
          ...
          pacemaker_simulink_B.ATR_GND_CTRL = 0.0;
          pacemaker_simulink_B.VENT_GND_CTRL = 1.0;
          if (pacemaker_simulink_P.HYSTERESIS_Value && tmp &&
              (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil(Gain3))
              && (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)
                  pacemaker_simulink_P.VENT_REFRAC_PERIOD_Value)) {
            pacemaker_simulink_DW.is_VVI = pacemaker_simulin_IN_Hysteresis;
            pacemaker_simulink_DW.temporalCounter_i1 = 0U;
            enter_atomic_Charging_and_Sen_m(&Gain5, &Gain1);
          } else if (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil
                     (60000.0 / pacemaker_simulink_P.LOWER_RATE_LIMIT_Value -
                      Gain3)) {
            ...
            if ((!pacemaker_simulink_P.HYSTERESIS_Value) && tmp &&
                (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil
                 (Gain3)) && (pacemaker_simulink_DW.temporalCounter_i1 >=
                              (uint32_T)
                              pacemaker_simulink_P.VENT_REFRAC_PERIOD_Value)) {
              pacemaker_simulink_DW.is_VVI = pacemak_IN_Charging_and_Sensing;
              pacemaker_simulink_DW.temporalCounter_i1 = 0U;
         ...
         case pacemaker_simulin_IN_Hysteresis:
          ...
          pacemaker_simulink_B.ATR_GND_CTRL = 0.0;
          pacemaker_simulink_B.VENT_GND_CTRL = 1.0;
          if (tmp && (pacemaker_simulink_DW.temporalCounter_i1 >= (uint32_T)ceil
                      (Gain3)) && (pacemaker_simulink_DW.temporalCounter_i1 >=
               (uint32_T)pacemaker_simulink_P.VENT_REFRAC_PERIOD_Value)) {
            pacemaker_simulink_DW.is_VVI = pacemaker_simulin_IN_Hysteresis;
            pacemaker_simulink_DW.temporalCounter_i1 = 0U;
            enter_atomic_Charging_and_Sen_m(&Gain5, &Gain1);
          } else {
  ...
  MW_PWM_SetDutyCycle(pacemaker_simulink_DW.obj_f.MW_PWM_HANDLE,
                      pacemaker_simulink_B.PACING_REF_PWM);
  ...
  MW_digitalIO_write(pacemaker_simulink_DW.obj_i.MW_DIGITALIO_HANDLE,
...
{
  {
    ...
    pacemaker_simulink_DW.obj.SampleTime =
      pacemaker_simulink_P.ATR_CMP_DETECT_SampleTime;
    obj = &pacemaker_simulink_DW.obj;
    pacemaker_simulink_DW.obj.isSetupComplete = false;
    pacemaker_simulink_DW.obj.isInitialized = 1;
    obj->MW_DIGITALIO_HANDLE = MW_digitalIO_open(0U, 0);
    pacemaker_simulink_DW.obj.isSetupComplete = true;
    ...
    obj_0 = &pacemaker_simulink_DW.obj_i;
...
void pacemaker_simulink_terminate(void)
{
  ...
  matlabCodegenHandle_matlabCodeg(&pacemaker_simulink_DW.obj_n);
  ...
  matlabCodegenHandle_matlabCo_o3(&pacemaker_simulink_DW.obj_i);
