 ...
 *
 * File: pacemaker_simulink_old_types.h
 *
...
#ifndef RTW_HEADER_pacemaker_simulink_old_types_h_
#define RTW_HEADER_pacemaker_simulink_old_types_h_
#include "rtwtypes.h"

/* Model Code Variants */

/* Custom Type definition for MATLABSystem: '<S11>/Serial Transmit' */
#include "MW_SVD.h"
...
/* Custom Type definition for MATLABSystem: '<S4>/Accel' */
#include "MW_I2C.h"
...
typedef struct P_pacemaker_simulink_old_T_ P_pacemaker_simulink_old_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_pacemaker_simulink_ol_T RT_MODEL_pacemaker_simulink_o_T;

#endif                          /* RTW_HEADER_pacemaker_simulink_old_types_h_ */
