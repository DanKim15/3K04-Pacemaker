###########################################################################
## Makefile generated for Simulink model 'pacemaker_simulink_old'. 
## 
## Makefile     : pacemaker_simulink_old.mk
## Generated on : Sat Nov 22 18:34:58 2025
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pacemaker_simulink_old.elf
...
PRODUCT_NAME              = pacemaker_simulink_old
MAKEFILE                  = pacemaker_simulink_old.mk
...
COMPILER_COMMAND_FILE     = pacemaker_simulink_old_comp.rsp
CMD_FILE                  = pacemaker_simulink_old.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pacemaker_simulink_old.elf
...
DEFINES_STANDARD = -DMODEL=pacemaker_simulink_old -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemaker_simulink_old.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/pacemaker_simulink_old.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemaker_simulink_old_data.o : $(START_DIR)/pacemaker_simulink_old_ert_rtw/pacemaker_simulink_old_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
