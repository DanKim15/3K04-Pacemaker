...
## Generated on : Sat Nov 22 22:40:54 2025
...
DEFINES_STANDARD = -DMODEL=pacemaker_simulink -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o MW_digitalIO.o MW_PWM.o rt_logging.o pacemaker_simulink.o pacemaker_simulink_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/pacemaker_simulink_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemaker_simulink_grt_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemaker_simulink_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemaker_simulink_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemaker_simulink_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
pacemaker_simulink.o : $(START_DIR)/pacemaker_simulink_grt_rtw/pacemaker_simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemaker_simulink_data.o : $(START_DIR)/pacemaker_simulink_grt_rtw/pacemaker_simulink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/pacemaker_simulink_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/pacemaker_simulink_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/pacemaker_simulink_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
