...
static void enter_atomic_Charging_and_Sen_m(void);
static void pacemaker_simulink_VVI(void);
static void enter_atomic_Charging_and_S_mil(void);
static void pacemaker_simulink_AAI(void);
static void enter_atomic_Charging_and_Sensi(void);
static void enter_atomic_Charging_and_Se_mi(void);
...
static void enter_atomic_Charging_and_Sen_m(void)
{
  ...
  pacemaker_simulink_B.PACING_REF_PWM = pacemaker_simulink_B.Gain1;
...
static void pacemaker_simulink_VVI(void)
{
  ...
  uint32_T qY;
  uint32_T tmp;
  if ((pacemaker_simulink_B.DataStoreRead_h != 3) &&
      (pacemaker_simulink_B.DataStoreRead_h != 7)) {
    ...
    if ((pacemaker_simulink_B.DataStoreRead_h == 0) ||
        (pacemaker_simulink_B.DataStoreRead_h == 1) ||
        (pacemaker_simulink_B.DataStoreRead_h == 2) ||
        (pacemaker_simulink_B.DataStoreRead_h == 3)) {
      current_LRI_ms = pacemaker_simulink_B.Cast2;
    } else {
      current_LRI_ms = pacemaker_simulink_B.Cast1;
    }
    ...
    switch (pacemaker_simulink_DW.is_VVI) {
     case pacemak_IN_Charging_and_Sensing:
      ...
      pacemaker_simulink_B.ATR_GND_CTRL = 0.0;
      pacemaker_simulink_B.VENT_GND_CTRL = 1.0;
      if (pacemaker_simulink_B.DataStoreRead9 &&
          pacemaker_simulink_B.VENT_CMP_DETECT &&
          (pacemaker_simulink_DW.temporalCounter_i1 >=
           pacemaker_simulink_B.DataStoreRead6_a) &&
          (pacemaker_simulink_DW.temporalCounter_i1 >=
           pacemaker_simulink_B.DataStoreRead8_n)) {
        pacemaker_simulink_DW.is_VVI = pacemaker_simulin_IN_Hysteresis;
        pacemaker_simulink_DW.temporalCounter_i1 = 0U;
        enter_atomic_Charging_and_Sen_m();
      } else {
        qY = (uint32_T)current_LRI_ms - pacemaker_simulink_B.DataStoreRead6_a;
     ...
     case pacemaker_simulin_IN_Hysteresis:
      ...
      if (pacemaker_simulink_B.VENT_CMP_DETECT &&
        ...
        qY = tmp - pacemaker_simulink_B.DataStoreRead6_a;
        if (qY > tmp) {
          qY = 0U;
        }
...
{
  pacemaker_simulink_B.FRONTEND_CTRL = 1.0;
  pacemaker_simulink_B.PACING_REF_PWM = pacemaker_simulink_B.Gain;
  pacemaker_simulink_B.PACE_CHARGE_CTRL = 1.0;
  pacemaker_simulink_B.PACE_GND_CTRL = 1.0;
  pacemaker_simulink_B.VENT_PACE_CTRL = 0.0;
  pacemaker_simulink_B.Z_ATR_CTRL = 0.0;
...
static void pacemaker_simulink_AAI(void)
{
  ...
  uint32_T qY;
  uint32_T tmp;
  if ((pacemaker_simulink_B.DataStoreRead_h != 2) &&
      (pacemaker_simulink_B.DataStoreRead_h != 6)) {
    ...
    switch (pacemaker_simulink_DW.is_AAI) {
     case pacemak_IN_Charging_and_Sensing:
      ...
      pacemaker_simulink_B.ATR_GND_CTRL = 1.0;
      pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
      qY = (uint32_T)current_LRI_ms - pacemaker_simulink_B.DataStoreRead5_c;
      if (qY > current_LRI_ms) {
        qY = 0U;
      }
      ...
      if (pacemaker_simulink_DW.temporalCounter_i1 >= qY) {
        ...
        pacemaker_simulink_B.VENT_GND_CTRL = 0.0;
        pacemaker_simulink_B.VENT_PACE_CTRL = 0.0;
      } else if ((!pacemaker_simulink_B.DataStoreRead9) &&
                 pacemaker_simulink_B.ATR_CMP_DETECT &&
                 (pacemaker_simulink_DW.temporalCounter_i1 >=
                  pacemaker_simulink_B.DataStoreRead5_c) &&
                 (pacemaker_simulink_DW.temporalCounter_i1 >=
                  pacemaker_simulink_B.DataStoreRead7_g)) {
        pacemaker_simulink_DW.is_AAI = pacemak_IN_Charging_and_Sensing;
        pacemaker_simulink_DW.temporalCounter_i1 = 0U;
        enter_atomic_Charging_and_S_mil();
      } else {
        if (pacemaker_simulink_B.DataStoreRead9 &&
            pacemaker_simulink_B.ATR_CMP_DETECT &&
            (pacemaker_simulink_DW.temporalCounter_i1 >=
     ...
     case pacemaker_simulin_IN_Hysteresis:
      ...
      if (pacemaker_simulink_B.ATR_CMP_DETECT &&
        ...
        qY = tmp - pacemaker_simulink_B.DataStoreRead5_c;
        if (qY > tmp) {
          qY = 0U;
        }
...
void pacemaker_simulink_step0(void)    /* Sample time: [0.001s, 0.0s] */
{
  ...
  if ((pacemaker_simulink_M->Timing.RateInteraction.TID0_1) > 19) {
    pacemaker_simulink_M->Timing.RateInteraction.TID0_1 = 0;
  }

  /* Chart: '<S7>/UART_Interface' */
  ...
  pacemaker_simulink_B.DataStoreRead = pacemaker_simulink_DW.DS_MODE_SELECT;
  ...
  pacemaker_simulink_B.DataStoreRead5 = pacemaker_simulink_DW.DS_ATR_PULSE_WIDTH;
  ...
  if (rtb_echo_request) {
    ...
    pacemaker_simulink_B.DataTypeConversion1 =
      pacemaker_simulink_DW.DS_HYSTERESIS;
  ...
  pacemaker_simulink_B.DataStoreRead_h = pacemaker_simulink_DW.DS_MODE_SELECT;

  /* Gain: '<S5>/Gain' incorporates:
   *  DataStoreRead: '<S5>/Data Store Read3'
   */
  pacemaker_simulink_B.Gain = (uint32_T)pacemaker_simulink_P.Gain_Gain *
    pacemaker_simulink_DW.DS_ATR_PULSE_AMP_REG;

  /* Gain: '<S5>/Gain1' incorporates:
   *  DataStoreRead: '<S5>/Data Store Read4'
   */
  pacemaker_simulink_B.Gain1 = (uint32_T)pacemaker_simulink_P.Gain1_Gain *
    pacemaker_simulink_DW.DS_VENT_PULSE_AMP_REG;
  ...
  pacemaker_simulink_B.DataStoreRead9 = pacemaker_simulink_DW.DS_HYSTERESIS;
   ...
   *  Product: '<S2>/Divide2'
   */
  rtb_Add1 = floor(pacemaker_simulink_P.Constant_Value / (real_T)
                   pacemaker_simulink_DW.DS_LOWER_RATE_LIMIT);
  ...
  pacemaker_simulink_B.Cast2 = (uint16_T)(rtb_Add1 < 0.0 ? (int32_T)(uint16_T)
    -(int16_T)(uint16_T)-rtb_Add1 : (int32_T)(uint16_T)rtb_Add1);

  /* End of DataTypeConversion: '<S2>/Cast2' */

  /* RateTransition: '<Root>/Rate Transition' */
  if (pacemaker_simulink_M->Timing.RateInteraction.TID0_1 == 1) {
   ...
   *  Sum: '<S13>/Subtract1'
   */
  rtb_Add1 = pacemaker_simulink_P.MAX_SENSOR_RATE_Value - (real_T)
    pacemaker_simulink_DW.DS_LOWER_RATE_LIMIT;
   ...
   *  Sum: '<S9>/Subtract1'
   */
  rtb_Add = rtb_Add1 / pacemaker_simulink_P.ResponseFactors_Value *
  ...
  if (pacemaker_simulink_B.RateTransition -
     ...
     */
    rtb_Add1 = rtb_Add1 / pacemaker_simulink_P.REACTION_TIME_min_Value /
     ...
     *  Sum: '<S10>/Subtract'
     */
    if (rtb_Add - rtb_Add1 > pacemaker_simulink_P.Switch_Threshold) {
      rtb_Add = rtb_Add1;
    }
     ...
     *  UnitDelay: '<S2>/Previous Rate'
     */
    rtb_Add = pacemaker_simulink_DW.PreviousRate_DSTATE - rtb_Add1 /
     ...
     *  Sum: '<S11>/Subtract'
     */
    if (!(rtb_Add - (real_T)pacemaker_simulink_DW.DS_LOWER_RATE_LIMIT >
          pacemaker_simulink_P.Switch_Threshold_f)) {
      rtb_Add = pacemaker_simulink_DW.DS_LOWER_RATE_LIMIT;
    }
   ...
   *  Product: '<S2>/Divide'
   */
  rtb_Add1 = floor(pacemaker_simulink_P.Constant_Value / rtb_Add);
  if (rtIsNaN(rtb_Add1) || rtIsInf(rtb_Add1)) {
    rtb_Add1 = 0.0;
  } else {
    rtb_Add1 = fmod(rtb_Add1, 65536.0);
  ...
  pacemaker_simulink_B.Cast1 = (uint16_T)(rtb_Add1 < 0.0 ? (int32_T)(uint16_T)
    -(int16_T)(uint16_T)-rtb_Add1 : (int32_T)(uint16_T)rtb_Add1);
  ...
  if (pacemaker_simulink_DW.is_active_c3_pacemaker_simulink == 0U) {
    ...
    switch (pacemaker_simulink_DW.is_c3_pacemaker_simulink) {
     case pacemaker_simulink_IN_AAI:
      pacemaker_simulink_AAI();
      break;

     case pacemaker_simulink_IN_AOO:
      if ((pacemaker_simulink_B.DataStoreRead_h != 0) &&
          (pacemaker_simulink_B.DataStoreRead_h != 4)) {
      ...
      } else if (pacemaker_simulink_DW.is_AOO == pacemak_IN_Charging_and_Sensing)
      {
        ...
        if ((pacemaker_simulink_B.DataStoreRead_h == 0) ||
            ...
            (pacemaker_simulink_B.DataStoreRead_h == 2) ||
            (pacemaker_simulink_B.DataStoreRead_h == 3)) {
          tmp = pacemaker_simulink_B.Cast2;
        } else {
          tmp = pacemaker_simulink_B.Cast1;
        }

        qY = (uint32_T)tmp - pacemaker_simulink_B.DataStoreRead5_c;
        if (qY > tmp) {
          qY = 0U;
        }
        ...
        if (pacemaker_simulink_DW.temporalCounter_i1 >=
          ...
          pacemaker_simulink_DW.temporalCounter_i1 = 0U;
          enter_atomic_Charging_and_Sensi();
        }
      }
      break;
     ...
     case pacemaker_simulink_IN_Start:
      if ((pacemaker_simulink_B.DataStoreRead_h == 0) ||
        ...
        pacemaker_simulink_DW.temporalCounter_i1 = 0U;
        enter_atomic_Charging_and_Sensi();
      } else if ((pacemaker_simulink_B.DataStoreRead_h == 1) ||
                 (pacemaker_simulink_B.DataStoreRead_h == 5)) {
        pacemaker_simulink_DW.is_c3_pacemaker_simulink =
          pacemaker_simulink_IN_VOO;
        pacemaker_simulink_DW.is_VOO = pacemak_IN_Charging_and_Sensing;
        pacemaker_simulink_DW.temporalCounter_i1 = 0U;
        enter_atomic_Charging_and_Se_mi();
      } else if ((pacemaker_simulink_B.DataStoreRead_h == 2) ||
                 (pacemaker_simulink_B.DataStoreRead_h == 6)) {
        pacemaker_simulink_DW.is_c3_pacemaker_simulink =
     ...
     case pacemaker_simulink_IN_VOO:
      if ((pacemaker_simulink_B.DataStoreRead_h != 1) &&
          (pacemaker_simulink_B.DataStoreRead_h != 5)) {
      ...
      } else if (pacemaker_simulink_DW.is_VOO == pacemak_IN_Charging_and_Sensing)
      {
        ...
        qY = (uint32_T)tmp - pacemaker_simulink_B.DataStoreRead6_a;
        if (qY > tmp) {
          qY = 0U;
        }
  ...
  /* Update for UnitDelay: '<S2>/Previous Rate' */
  pacemaker_simulink_DW.PreviousRate_DSTATE = rtb_Add;

  /* Matfile logging */
  rt_UpdateTXYLogVars(pacemaker_simulink_M->rtwLogInfo,
                      (&pacemaker_simulink_M->Timing.taskTime0));

  /* signal main to stop simulation */
  {                                    /* Sample time: [0.001s, 0.0s] */
    if ((rtmGetTFinal(pacemaker_simulink_M)!=-1) &&
        !((rtmGetTFinal(pacemaker_simulink_M)-
           pacemaker_simulink_M->Timing.taskTime0) >
          pacemaker_simulink_M->Timing.taskTime0 * (DBL_EPSILON))) {
      rtmSetErrorStatus(pacemaker_simulink_M, "Simulation finished");
    }
  }
   ...
   */
  if (!(++pacemaker_simulink_M->Timing.clockTick0)) {
    ++pacemaker_simulink_M->Timing.clockTickH0;
  }

  pacemaker_simulink_M->Timing.taskTime0 =
    pacemaker_simulink_M->Timing.clockTick0 *
    pacemaker_simulink_M->Timing.stepSize0 +
    pacemaker_simulink_M->Timing.clockTickH0 *
    pacemaker_simulink_M->Timing.stepSize0 * 4294967296.0;
}
...
void pacemaker_simulink_initialize(void)
{
  ...
  (void) memset((void *)pacemaker_simulink_M, 0,
                sizeof(RT_MODEL_pacemaker_simulink_T));
  (pacemaker_simulink_M)->Timing.TaskCounters.cLimit[0] = 1;
  (pacemaker_simulink_M)->Timing.TaskCounters.cLimit[1] = 20;
  rtmSetTFinal(pacemaker_simulink_M, 10.0);
  pacemaker_simulink_M->Timing.stepSize0 = 0.001;

  /* Setup for data logging */
  {
    static RTWLogInfo rt_DataLoggingInfo;
    rt_DataLoggingInfo.loggingInterval = NULL;
    pacemaker_simulink_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(pacemaker_simulink_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(pacemaker_simulink_M->rtwLogInfo, (NULL));
    rtliSetLogT(pacemaker_simulink_M->rtwLogInfo, "tout");
    rtliSetLogX(pacemaker_simulink_M->rtwLogInfo, "");
    rtliSetLogXFinal(pacemaker_simulink_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(pacemaker_simulink_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(pacemaker_simulink_M->rtwLogInfo, 4);
    rtliSetLogMaxRows(pacemaker_simulink_M->rtwLogInfo, 0);
    rtliSetLogDecimation(pacemaker_simulink_M->rtwLogInfo, 1);
    rtliSetLogY(pacemaker_simulink_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(pacemaker_simulink_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(pacemaker_simulink_M->rtwLogInfo, (NULL));
  }

  /* block I/O */
  (void) memset(((void *) &pacemaker_simulink_B), 0,
                sizeof(B_pacemaker_simulink_T));

  /* states (dwork) */
  (void) memset((void *)&pacemaker_simulink_DW, 0,
                sizeof(DW_pacemaker_simulink_T));

  /* Matfile logging */
  rt_StartDataLoggingWithStartTime(pacemaker_simulink_M->rtwLogInfo, 0.0,
    rtmGetTFinal(pacemaker_simulink_M), pacemaker_simulink_M->Timing.stepSize0,
    (&rtmGetErrorStatus(pacemaker_simulink_M)));
  ...
  pacemaker_simulink_DW.DS_VENT_PULSE_AMP_REG =
    pacemaker_simulink_P.DataStoreMemory_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory1' */
  pacemaker_simulink_DW.DS_ATR_PULSE_WIDTH =
    pacemaker_simulink_P.DataStoreMemory1_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory2' */
  pacemaker_simulink_DW.DS_VENT_PULSE_WIDTH =
    pacemaker_simulink_P.DataStoreMemory2_InitialValue;
  ...
  pacemaker_simulink_DW.DS_MODE_SELECT =
    pacemaker_simulink_P.DataStoreMemory5_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory6' */
  pacemaker_simulink_DW.DS_HYSTERESIS =
    pacemaker_simulink_P.DataStoreMemory6_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory7' */
  pacemaker_simulink_DW.DS_LOWER_RATE_LIMIT =
    pacemaker_simulink_P.DataStoreMemory7_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory8' */
  pacemaker_simulink_DW.DS_UPPER_RATE_LIMIT =
    pacemaker_simulink_P.DataStoreMemory8_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory9' */
  pacemaker_simulink_DW.DS_ATR_PULSE_AMP_REG =
    pacemaker_simulink_P.DataStoreMemory9_InitialValue;

  {
    ...
    /* SystemInitialize for Chart: '<S7>/UART_Interface' */
    pacemaker_simulink_DW.temporalCounter_i1_k = 0U;
    pacemaker_simulink_DW.is_active_c1_pacemaker_simulink = 0U;
    pacemaker_simulink_DW.is_c1_pacemaker_simulink =
      pacemaker_si_IN_NO_ACTIVE_CHILD;

    /* SystemInitialize for Chart: '<Root>/Pacemaker' */
    pacemaker_simulink_DW.is_AAI = pacemaker_si_IN_NO_ACTIVE_CHILD;
    pacemaker_simulink_DW.is_AOO = pacemaker_si_IN_NO_ACTIVE_CHILD;
    pacemaker_simulink_DW.is_VOO = pacemaker_si_IN_NO_ACTIVE_CHILD;
    pacemaker_simulink_DW.is_VVI = pacemaker_si_IN_NO_ACTIVE_CHILD;
    pacemaker_simulink_DW.temporalCounter_i1 = 0U;
    pacemaker_simulink_DW.is_active_c3_pacemaker_simulink = 0U;
    pacemaker_simulink_DW.is_c3_pacemaker_simulink =
      pacemaker_si_IN_NO_ACTIVE_CHILD;
    ...
    pacemaker_simulink_DW.objisempty = true;
    pacemaker_simulink_DW.obj_i.SampleTime =
      pacemaker_simulink_P.ATR_CMP_DETECT_SampleTime;
    ...
    pacemaker_simulink_DW.objisempty_j = true;
    pacemaker_simulink_DW.obj_n.SampleTime =
      pacemaker_simulink_P.VENT_CMP_DETECT_SampleTime;
    ...
    pacemaker_simulink_DW.objisempty_k = true;
    ...
    pacemaker_simulink_DW.objisempty_h = true;
    ...
    pacemaker_simulink_DW.objisempty_b = true;
    ...
    pacemaker_simulink_DW.objisempty_n = true;
    ...
    pacemaker_simulink_DW.objisempty_m = true;
    ...
    pacemaker_simulink_DW.objisempty_o = true;
    ...
    pacemaker_simulink_DW.objisempty_m3 = true;
    ...
    pacemaker_simulink_DW.objisempty_jb = true;
    ...
    pacemaker_simulink_DW.objisempty_c = true;
    ...
    pacemaker_simulink_DW.objisempty_d = true;
    ...
    pacemaker_simulink_DW.objisempty_h1 = true;
    ...
    pacemaker_simulink_DW.objisempty_hr = true;
    ...
    pacemaker_simulink_DW.objisempty_o1 = true;
    pacemaker_simulink_DW.obj.SampleTime =
      pacemaker_simulink_P.FXOS87006AxesSensor_SampleTime;
