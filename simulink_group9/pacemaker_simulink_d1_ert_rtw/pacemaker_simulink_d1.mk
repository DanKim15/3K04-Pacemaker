###########################################################################
## Makefile generated for Simulink model 'pacemaker_simulink_d1'. 
## 
## Makefile     : pacemaker_simulink_d1.mk
## Generated on : Sat Nov 22 18:55:18 2025
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pacemaker_simulink_d1.elf
...
PRODUCT_NAME              = pacemaker_simulink_d1
MAKEFILE                  = pacemaker_simulink_d1.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/danie/Documents/Uni/Y3/Y3S1/3K04/3K04-Pacemaker/simulink_group9
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = pacemaker_simulink_d1_comp.rsp
CMD_FILE                  = pacemaker_simulink_d1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pacemaker_simulink_d1.elf
...
DEFINES_STANDARD = -DMODEL=pacemaker_simulink_d1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o pacemaker_simulink_d1.o pacemaker_simulink_d1_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemaker_simulink_d1.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/pacemaker_simulink_d1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemaker_simulink_d1_data.o : $(START_DIR)/pacemaker_simulink_d1_ert_rtw/pacemaker_simulink_d1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
