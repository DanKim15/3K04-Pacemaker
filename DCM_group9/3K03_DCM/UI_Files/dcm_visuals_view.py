...
class DCMVisualsView(ttk.Frame):
    ...
    def _build(self):
        ...
        # frame for the communication status display
        ...
        # frame for the pacemaker detection status
        ...
        # Status label for any other pacemaker detection
        ...
        # Test buttons (for demonstration - remove in production)
